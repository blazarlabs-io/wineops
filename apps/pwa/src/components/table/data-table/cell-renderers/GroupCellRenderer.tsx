...
export const GroupCellRenderer: FunctionComponent<CustomCellRendererProps> = ({ node, value }) => {
  ...
  return (
    <div className="flex items-start justify-center flex-col gap-2">
      ...
      {node.data && node.data.info && node.data.info.certifications ? (
        <CertificationsDataDisplay certifications={node.data.info.certifications} />
      ) : (
