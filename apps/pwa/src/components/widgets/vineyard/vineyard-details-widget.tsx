...
export default function VineyardDetailsWidget({
  ...
  useEffect(() => {
    ...
    console.log("localVineyard", localVineyard.labData);
  }, [vineyard]);
      ...
      <TabPanel value={value} index={1}>
        <div className="flex flex-col w-full gap-4">
          <div className="flex flex-col w-full gap-2">
            ...
            {localVineyard.grape ? (
              <div
                style={{ border: "4px solid var(--mui-palette-divider)" }}
                className="flex p-4 w-full gap-4 justify-between rounded-md bg-red-500"
              >
                <SimpleDataDisplay
