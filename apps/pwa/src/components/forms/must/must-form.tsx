...
export default function MustForm({
  ...
  const [formData, setFormData] = useState<Must | undefined>(must);
  ...
  useEffect(() => {
    const name = `Must_${musts?.length + 1}`;
                      ...
                      <Stack direction="row" gap={2} alignItems="center">
                        <FormControl sx={{ flex: 1 }}>
                          <Input
                            ...
                            slotProps={{ htmlInput: { min: 0, step: "any" } }}
                            {...register(
                              "labData.yeastActivityPopulation.value"
                            )}
                          />
                        </FormControl>
                        ...
                        <FormControl sx={{ display: "none" }}>
                          <Input
                            ...
                            variant="outlined"
                            value={
                              formData?.labData?.yeastActivityPopulation
                                ?.unit || "million cells/mL"
                            }
                            {...register(
                              "labData.yeastActivityPopulation.unit"
                            )}
                          />
                        </FormControl>
                      ...
                      <Stack direction="row" gap={2} alignItems="center">
                        ...
                        <FormControl sx={{ display: "none" }}>
                          <Input
                            ...
                            variant="outlined"
                            value={
                              formData?.labData?.yeastAssimilableNitrogen
                                ?.unit || "mg N/L"
                            }
                            {...register(
                              "labData.yeastAssimilableNitrogen.unit"
                            )}
                          />
                        </FormControl>
