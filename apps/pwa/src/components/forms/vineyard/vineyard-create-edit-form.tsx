...
import { vineyardFormSchema } from "@/models/schemas/vineyard-form-schema";
import {
  Coordinates,
  DbResponse,
  FormMode,
...
export default function VineyardForm({
  ...
  const {
    ...
    resolver: joiResolver(vineyardFormSchema),
  });
  ...
  const watchedMapCoordinates = watch("info.location.map");
  ...
  const handleNameChange = useCallback(
    ...
    [checkIfNameExists, setValue, onNameError],
  );

  const handlePolygonDrawingComplete = (data: Coordinates[]) => {
    setValue("info.location.map", data);
  };
  ...
  const handleArrayChange = (name: string, value: string) => {
    ...
    setValue(name as any, newValues);
  };
  ...
  const handleCreateVineyard = useCallback(
    async (uid: string, data: any) => {
      ...
      try {
        if (formType === "edit") {
          ...
          const createRes: DbResponse = await db.vineyard.create(
            uid,
            cleanData,
          );

          if (createRes.status === 200) {
            enqueueSnackbar(`Created ${cleanData.name} successfully`, {
              variant: "success",
            });
            if (closeDrawer) closeDrawer();
          } else {
        ...
        enqueueSnackbar(
          `Error ${formType === "edit" ? "updating" : "creating"} vineyard`,
          {
            variant: "error",
          },
        );
    ...
    [closeDrawer, enqueueSnackbar, formType],
  );
  ...
  useEffect(() => {
    const initializeForm = async () => {
      ...
      if (!existingVineyard) {
        try {
          const validName = await resolveName(name);
          name = validName;
        } catch (err: any) {}
      }

      if (existingVineyard) {
        reset(existingVineyard);
      } else {
        const newVineyard = {
                  ...
                  <div className="p-0 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="w-full bg-muted rounded-md min-h-[320px] relative">
                        <PolygonDrawingMap
                          initialCoordinates={watchedMapCoordinates}
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        {(errors?.info as any)?.location?.city && (
                          <p className="text-sm text-destructive  mt-1">
                            {(errors?.info as any)?.location?.city?.message}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="flex flex-col gap-2 justify-between">
                        ...
                        />
                        {(errors?.info as any)?.vines?.sunlightHours && (
                          <p className="text-sm text-destructive  mt-1">
                            {
                              (errors?.info as any)?.vines?.sunlightHours
                                ?.message
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-col gap-2 w-full">
                          ...
                          {(errors?.info as any)?.vines?.soilType && (
                            <p className="text-sm text-destructive  mt-1">
                              {(errors?.info as any)?.vines?.soilType?.message}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        <div className="grid grid-cols-2">
                          <div className="flex flex-col gap-2 justify-between">
                            <div className="flex flex-col gap-2">
                              <div className="flex items-center gap-2">
                                <Controller
                                  name="info.certifications.eco.active"
                                  control={control}
                                  render={({ field }) => (
                                    <Checkbox
                                      {...field}
                          ...
                          <div className="flex flex-col gap-2 justify-between">
                            <div className="flex flex-col gap-2">
                              <div className="flex items-center gap-2">
                                <Controller
                                  name="info.certifications.bio.active"
                                  control={control}
                                  render={({ field }) => (
                                    <Checkbox
                                      {...field}
                          ...
                          <div className="flex flex-col gap-2 justify-between">
                            <div className="flex flex-col gap-2">
                              <div className="flex items-center gap-2">
                                <Controller
                                  name="info.certifications.igp.active"
                                  control={control}
                                  render={({ field }) => (
                                    <Checkbox
                                      {...field}
                          ...
                          <div className="flex flex-col gap-2 justify-between">
                            <div className="flex flex-col gap-2">
                              <div className="flex items-center gap-2">
                                <Controller
                                  name="info.certifications.dop.active"
                                  control={control}
                                  render={({ field }) => (
                                    <Checkbox
                                      {...field}
                        ...
                        <div className="flex flex-col gap-2 justify-between">
                          <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                              <Controller
                                name="info.certifications.ice.active"
                                control={control}
                                render={({ field }) => (
                                  <Checkbox
                                    {...field}
                  ...
                  <div className="p-4 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex flex-col gap-2 w-full">
                        ...
                        />
                        {(errors?.grape as any)?.countryOfOrigin && (
                          <p className="text-sm text-destructive  mt-1">
                            {(errors?.grape as any)?.countryOfOrigin?.message}
                          </p>
                        )}
                      </div>
                    </div>
