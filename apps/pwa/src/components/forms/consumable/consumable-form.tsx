...
export default function ConsumableForm({
  ...
  const [formData, setFormData] = useState<Consumable | undefined>(consumable);
  ...
  useEffect(() => {
    const consumableID = `Consumable_${consumables?.length + 1}`;
  ...
  }, [reset, consumable, consumables?.length]);
                      ...
                      <div className="flex flex-col gap-2 w-full">
                        ...
                        <FormControl>
                          ...
                          >
                            ...
                            {Object.values(ConsumableCategory).map(
                              (category) => (
