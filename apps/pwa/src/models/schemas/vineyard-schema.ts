...
export const vinesSchema = Joi.object<Vines>({
...
export const vineyardCertificationsSchema = Joi.object({
  eco: Joi.object({
...
export const vineyardInfoSchema = Joi.object<VineyardInfo>({
  location: locationSchema,
  vines: vinesSchema,
  certifications: vineyardCertificationsSchema,
});

export const vineyardGrapeSchema = Joi.object({
